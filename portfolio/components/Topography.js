...
const applyColor = value => {
  ...
  const low = program.uniforms.uLow.value;
  const mid = program.uniforms.uMid.value;
  const high = program.uniforms.uHigh.value;
...
const unsubscribeColor = color?.on("change", applyColor);

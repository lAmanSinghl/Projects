  ...
  return (
    <section ref={heroRef} className="relative h-[250vh] ">
      ...
      <div className="sticky top-0 h-screen overflow-hidden ">
        ...
        <motion.div style={{ scale: smoothScale, borderRadius, transformOrigin: "center center", backgroundColor: bgColor2 }} className="h-screen overflow-hidden flex justify-center">

          <div className="absolute inset-0 pointer-events-none">
            <Topography lowColor="#000000" midColor="#000000" highColor="#000000" speed={0.25} morphAmount={3} morphSpeed={0.05} bands={3} thickness={0.04} scale={2} pixelSize={1} glow={0} colorMode="uniform" contrast={3} brightness={1} fillBands={false} opacity={0.15} grain={false} mouseInteraction={false} />
          </div>

          <div className="flex items-center mt-31 w-[80%] justify-center font-datatype ">
            <motion.img style={{ filter: imageFilter }} className="absolute left-121 top-14 right-6 w-130 pointer-events-none" src="Firefly4.png" alt="" />
            <motion.img style={{ filter: imageFilter }} className="relative -top-[35.8px] right-6 w-130 pointer-events-none" src="Firefly.png" alt="" />
          </div>

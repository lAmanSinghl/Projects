        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <motion.div style={{ x: useTransform(horizontalProgress, [0, 0.75], ["0%", "-170%"]) }} className="flex">
            <section className="w-screen h-screen shrink-0">
              ...
              <div className=" absolute top-94 left-380  w-70 h-78  overflow-hidden rounded-xl scale-78"><img src="Screenshot_2026-06-11-12-08-43-003_com.instagram.android-edit.jpg.jpeg" style={{ filter: "grayscale(150%) sepia(50%) brightness(0.6) contrast(0.95)" }} alt="" className="absolute w-200 scale-130 -top-25 right-10 opacity-80" /></div>

              <div className="absolute text-[#B4B8A5] left-412 top-162 w-35 scale-70">
              ...
              <div className="relative top-70 left-430 w-fit scale-70 font-datatype text-[#B4B8A5] ">
                <img src="school1.webp" alt="" className="rounded-xl w-220" />
              ...
              <div className=" absolute top-90 left-680  w-60 h-78  overflow-hidden rounded-xl "><img src="IMG-20250428-WA0003.jpg.jpeg" alt="" className="absolute w-200 scale-160 -top-18 " /></div>
              <div className="absolute text-[#4a4b48]  left-717 top-167 w-42 scale-70">
              ...
              <div className="absolute top-73  left-735 w-210  scale-80 font-datatype text-[#565752] ">
                <img src="a7.jpg (1).jpeg" alt="" className="rounded-xl w-220" />
